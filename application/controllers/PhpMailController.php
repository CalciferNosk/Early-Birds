...
class PhpMailController extends CI_Controller{
    ...
    function send(){
        ...
        $mail->SMTPAuth = true;
        $mail->Username = '#';#GMAIL
        $mail->Password = 'PASSWORD'; # create here https://myaccount.google.com/apppasswords?pli=1&rapt=AEjHL4N3Ucs5jEph3Jsr49Anyj_GTq2DJCMP_Z5del3rXoqDdl8B0JgtCjiGBRVZGwJQNXae35bVh976JwH5z3Q8kRDZGPfupg
        $mail->SMTPSecure = 'tls';
